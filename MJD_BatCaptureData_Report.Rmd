...
output_today
# "C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/BatLab Norway/Projects/Noctur/Analyses/Outputs/Reed/CleanBatCaptureData2024_2024-12-21

boxcap <- read_csv("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/BatLab Norway/Projects/Noctur/Data/Bat_Boxes/Bat captures/survey123_BatCapture_2024.csv", 
    col_types = cols(ObjectID = col_skip()))

boxes <- read_excel("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/BatLab Norway/Projects/Noctur/Data/Bat_Boxes/Site Information/Bat Box Site Overview v2.xlsx")

sboxes <- read_csv("C:/Users/apmc/OneDrive - Norwegian University of Life Sciences/BatLab Norway/Projects/Noctur/Data/Bat_Boxes/Site Information/survey123_batboxoverivew_2024.csv")
```
...
```{r}
bcap <- boxcap %>% 
  select('Bat box ID', 'Bat ID', 'Sex and reproductive status', 
                          'Right forearm length (mm)', "Weight (g)", 
                          "Band number", "Bat species", "Age") %>% 
  rename(BBid = 'Bat box ID',
         BatID  = 'Bat ID',
