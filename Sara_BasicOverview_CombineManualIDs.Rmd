...
df5$mid4 <- factor(gsub("PPYG.", "PPYG", df5$mid3)) 
summary(df5$mid4)

 # ENIL    MY  NNOC    NY  NYCT  NoID Noise  PAUR    PN 
 # 3982   732   517  3258     2    56  4206    68  2902 
 #   PP  PPYG  VMUR 
 #   43  6608     3 
...
df7 <- df5 %>% mutate(manual.id = factor(case_when(
  ...
  dplyr::select(-c(manual_pass, manualid, mid, mid1, mid2, mid3, mid4))
names(df7)

summary(df7$manual.id)
 # ENIL  MYOT  NNOC  NYCT  NoID Noise  PAUR  PISP  PNAT 
 # 3982   732   517  3260    56  4206    68    43  2902 
 # PPYG  VMUR 
 # 6608     3 
