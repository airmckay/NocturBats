...
## Need to look at equipment failures later. For now, make a list of dates when the detectors were all deployed and assume that they were working the whole time. 


#Three different deployment date ranges for the six detectors 
# These are the dates that the detectors were deployed - the day that they were retreived to account for how our data will be aggregated to night. 
