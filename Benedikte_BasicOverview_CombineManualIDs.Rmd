...
#Utsira
inputUT01 <- read_csv("E:/Benedikte/MSC/ID/UT-01/id.csv")
# 1146 obs of 44 vars
# Add a site column 
inputUT01$site <- "UT-01"

## Gismarvik
inputGI01 <- read_csv("E:/Benedikte/MSC/ID/GI-01/id.csv")
# 7492 obs of 44 vars
# Add a site column 
inputGI01$site <- "GI-01"

inputGI03 <- read_csv("E:/Benedikte/MSC/ID/GI-03/id.csv")
# 1862 obs of 44 vars 
# Add a site column 
...
## Utsira 
inputCM01<- read_csv("E:/Benedikte/MSC/ID/CM-01/id.csv") 
# 3373 obs of 44 vars
# Add a site column 
inputCM01$site <- "CM-01"

inputCM02<- read_csv("E:/Benedikte/MSC/ID/CM-02/id.csv") 
# 576 obs of 44 vars
# Add a site column 
inputCM02$site <- "CM-02"

## Gismarvik
inputCM46<- read_csv("E:/Benedikte/MSC/ID/CM-46/id.csv") 
# 5050 obs of 44 vars
# Add a site column 
